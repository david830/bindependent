...
beadfile = [stem1107 'Time_data/2012-11-07_BEADS-T26_28_30_48_69_72_P3.fcs'];
blankfile = [stem1107 'Time_data/T69-1_C11_C11_P3.fcs'];
channels{1} = Channel('Pacific Blue-A', 405, 0, 0);
channels{1} = setPrintName(channels{1}, 'Blue');
channels{1} = setLineSpec(channels{1}, 'b');
colorfiles{1} = [stem1107 'Time_data/T69-1_C8_C08_P3.fcs'];

channels{2} = Channel('PE-Tx-Red-YG-A', 561, 610, 20);
channels{2} = setPrintName(channels{2}, 'Red');
channels{2} = setLineSpec(channels{2}, 'r');
colorfiles{2} = [stem1107 'Time_data/T69-1_C7_C07_P3.fcs'];

channels{3} = Channel('FITC-A', 488, 515, 20);
channels{3} = setPrintName(channels{3}, 'Yellow');
channels{3} = setLineSpec(channels{3}, 'y');
colorfiles{3} = [stem1107 'Time_data/T69-1_C9_C09_P3.fcs'];

colorpairfiles{1} = {channels{2}, channels{3}, channels{1}, [stem1107 'Time_data/T69-1_C10_C10_P3.fcs']};
colorpairfiles{2} = {channels{3}, channels{1}, channels{2}, [stem1107 'Time_data/T69-1_C10_C10_P3.fcs']};
colorpairfiles{3} = {channels{1}, channels{2}, channels{3}, [stem1107 'Time_data/T69-1_C10_C10_P3.fcs']};
