function err = test_repressor_bin_ode_model_packed_simplified_TAL21_hc_known(data,param)
...
for i=1:21,     % plasmid copy counts
    for j=1:12, % Dox levels
        ...
        [T,Y] = ode15s(@hill_ODE_hour_new_packed_simplified_TAL21_hc_known,tspan,[0;0],[]);
