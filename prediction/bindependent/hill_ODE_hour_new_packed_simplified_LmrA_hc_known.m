...
function dy = hill_ODE_hour_new_packed_simplified_LmrA_hc_known(t, y)
...
dOut = R1.alpha_out * P_eff * P^R1.G4 / (1 + (In / (R1.DK * P^R1.G3) )^0.61) + R1.alpha_out/77 * P_eff * P^R1.G4 - dilution*Out;
