...
function dy = hill_ODE_hour_new_packed_simplified_TAL14_hc_known(t, y)
...
dOut = R1.alpha_out * P_eff * P^R1.G4 / (1 + (In / (R1.DK * P^R1.G3) )^1) + R1.alpha_out/10^3.17 * P_eff * P^R1.G4 - dilution*Out;
